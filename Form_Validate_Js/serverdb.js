...
// API's
app.listen(3000, api.listen);
app.get("/api/users", api.getEmployeeData);
app.get("/api/skills", api.getSkillsData);
app.get("/api/users/:name", api.searchData);
app.post("/api/add", api.addData);
app.get("/api/prefill/:id", api.prefillData);
app.post("/api/updatedata", api.updateData,api.hello);
